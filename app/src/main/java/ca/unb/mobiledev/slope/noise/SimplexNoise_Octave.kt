package ca.unb.mobiledev.slope.noise

import kotlin.random.Random

/*
 * A speed-improved simplex noise algorithm for 2D, 3D and 4D in Kotlin/Java.
 *
...
class SimplexNoise_Octave(seed: Int) {
